...
export function useApplicationsFindMany<
  T extends Prisma.applicationsFindManyArgs,
  R extends GetFindResult<Prisma.$applicationsPayload<DefaultArgs>, T>[],
>(
  args?: Prisma.SelectSubset<T, Prisma.applicationsFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useApplicationsFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.applications.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useApplicationsCount<T extends Prisma.applicationsCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.applicationsCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useApplicationsCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.applications.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useApplicationsFindManyWithCount<
  T extends Prisma.applicationsFindManyArgs,
  R extends { data: GetFindResult<Prisma.$applicationsPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.applicationsFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useApplicationsFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.applications.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useApplicationsFindFirst<
  T extends Prisma.applicationsFindFirstArgs,
  R extends GetFindResult<Prisma.$applicationsPayload<DefaultArgs>, T>,
>(
  args?: Prisma.SelectSubset<T, Prisma.applicationsFindFirstArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useApplicationsFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.applications.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobsFindMany<
  T extends Prisma.jobsFindManyArgs,
  R extends GetFindResult<Prisma.$jobsPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.jobsFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobsFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.jobs.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobsCount<T extends Prisma.jobsCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.jobsCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobsCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.jobs.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobsFindManyWithCount<
  T extends Prisma.jobsFindManyArgs,
  R extends { data: GetFindResult<Prisma.$jobsPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.jobsFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobsFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.jobs.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobsFindFirst<
  T extends Prisma.jobsFindFirstArgs,
  R extends GetFindResult<Prisma.$jobsPayload<DefaultArgs>, T>,
>(
  args?: Prisma.SelectSubset<T, Prisma.jobsFindFirstArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobsFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.jobs.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
