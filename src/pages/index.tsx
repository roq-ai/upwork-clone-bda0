  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upwork Clone - Bridging the Gap Between Freelancers and Job Owners, Streamlining Your Journey Towards Success"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1664575196644-808978af9b1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2VyfGVufDB8fHx8MTY5OTg4ODE1NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upwork Clone - Bridging the Gap Between Freelancers and Job Owners, Streamlining Your Journey Towards Success`}
            </Text>
            <Box
